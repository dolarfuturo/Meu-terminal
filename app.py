...
# Configuração da Página - Bloomberg Style
st.set_page_config(page_title="TERMINAL FINANCEIRO", layout="wide")

# CSS Bloomberg Style - Fundo Preto e Nomes em Branco Forte
st.markdown("""
    <style>
    .stApp { background-color: #000000; color: #FFFFFF; }
    [data-testid="stHeader"] { background-color: #000000; }
    
    /* Nomes dos Ativos em Branco Forte */
    ...
    /* Valores das Métricas em Amarelo Âmbar */
...
if not spot_df.empty:
    ...
    spot_ref = spot_df['Close'].iloc[0] # Para cálculo da variação do dia
    ...
    with p1:
        st.markdown(f"""
            <div class="frp-box">
                <span style="color:#FF0000; font-weight:bold;">MÍNIMA FRP (+{v_min})</span>
    ...
    with p2:
        st.markdown(f"""
            <div class="frp-box">
                <span style="color:#0080FF; font-weight:bold;">PREÇO JUSTO FRP (+{v_justo})</span>
    ...
    with p3:
        st.markdown(f"""
            <div class="frp-box">
                <span style="color:#00FF00; font-weight:bold;">MÁXIMA FRP (+{v_max})</span>
