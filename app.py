...
# 4. CSS DO TERMINAL (Ajustado para Fontes Maiores)
st.markdown("""
<style>
    ...
    .vies-indicator { font-size: 16px; font-weight: 900; margin-top: 8px; font-family: 'Orbitron'; }
    .d-row { display: flex; justify-content: space-between; align-items: center; padding: 18px 15px; border-bottom: 1px solid #111; }
    .d-label { font-size: 14px; color: #FFFFFF; font-weight: 900; width: 40%; letter-spacing: 1px; }
    ...
    .sub-l { font-size: 10px; color: #888; margin-bottom: 2px; font-weight: 700; }
    .sub-v { font-size: 22px; font-family: 'Chakra Petch'; font-weight: 700; }
    .v-peq { font-size: 18px; font-family: 'Chakra Petch'; font-weight: 700; color: #ffff00; }
    .v-extra { font-size: 13px; font-family: 'Chakra Petch'; color: #ffff00; opacity: 0.5; margin-top: 1px; }
...
def monitor_terminal():
    ...
    if s_m["last"] > 0:
        ...
        # AJUSTE: MÉDIA AZUL COM FONTE "CHAKRA PETCH" E TAMANHO MAIOR (26px) IGUAL AOS OUTROS
        st.markdown(f"""
            <div class="s-container">
                ...
                <div class="vies-indicator" style="color:{fut_clr}">{fut_seta} 
                    <span style="color:#0066cc; margin-left:15px; font-family:'Chakra Petch'; font-size:26px;">{media_azul:.4f}</span>
                </div>
            </div>
        """, unsafe_allow_html=True)
