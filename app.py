...
# Configuração da página e Sidebar aberta
...
# CSS para layout limpo, cores e fontes
st.markdown("""
    <style>
    ...
    * { font-family: 'Roboto Mono', monospace !important; text-transform: uppercase; }
    ...
    .trava-orange { color: #FF8C00 !important; font-size: 18px; margin-top: 10px; font-weight: bold; }
    </style>
    """, unsafe_allow_html=True)

# SET DE VARIÁVEIS NA ESQUERDA
with st.sidebar:
...
# Loop de atualização (2 segundos)
...
while True:
    with placeholder.container():
        ...
        if spot_df is not None:
            # Pega o último preço fechado (evita erro de Series)
