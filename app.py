...
# 2. INICIALIZAÇÃO DE VARIÁVEIS (MATRIZ ORIGINAL)
...
# 3. CSS (NEGRITO E BRANCO NOS TÍTULOS)
st.markdown("""
<style>
    ...
    .d-label { font-size: 11px; font-weight: 900; color: #fff; text-transform: uppercase; } /* NEGRITO E BRANCO */
...
# 4. MENU SET (PTAX, AJUSTE E VARIÁVEIS)
...
# 5. ÁREA DO TERMINAL (ESTÁTICA + LOOP DE DADOS)
...
while True:
    ...
    if s_p > 0:
        # EQUILÍBRIO MATRIZ: PTAX + V22
        equi = st.session_state.ptax + st.session_state.v22
        
        # SENSÌVEL AO MERCADO (Gauge)
