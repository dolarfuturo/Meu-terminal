...
<style>
    ...
    /* CORES UNIFICADAS POR LINHA (RÓTULO E VALOR COM A MESMA COR) */
...
def monitor_terminal():
    ...
    if s_m["last"] > 0:
        ...
        <div class="d-row"><div class="d-label txt-yellow-line">MED FUT 1</div><div class="d-value txt-yellow-line">{med_fut_1_down:.4f}</div></div>
        <div class="d-row"><div class="d-label txt-green-line">MIN FUT 1</div><div class="d-value txt-green-line">{min_fut_1:.4f}</div></div>
        <div class="d-row"><div class="d-label txt-yellow-line">MED FUT 2</div><div class="d-value txt-yellow-line">{med_fut_2_down:.4f}</div></div>
