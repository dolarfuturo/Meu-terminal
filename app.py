...
# Configuração de Tela para Split-Screen
...
def get_data(ticker, is_spot=False):
    try:
        t = yf.Ticker(ticker)
        # Tenta pegar 1m para IB, senão diário
...
with st.expander("SET"):
    ...
    # Ajuste inicia automático com o fechamento de ontem
...
led_html = f'<div class="ticker-wrap"><div class="ticker">DI27: {fdi(d27, d27v)} | DI29: {fdi(d2
