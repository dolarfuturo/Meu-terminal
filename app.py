...
while True:
    ...
    with placeholder.container():
        ...
        if s_df is not None and not s_df.empty:
            ...
            # CÁLCULOS SEPARADOS PARA EVITAR ERROS DE SINTAXE
            ...
            # EWZ + LÓGICA DE PRÉ-MERCADO SEPARADA
            if is_pre:
                # Linha normal com fechamento anterior
                ...
                # Linha amarela menor com variação do Pré
                ...
                # Mercado aberto: mostra preço e variação atual na linha principal
