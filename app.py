...
st.markdown("""
    ...
    * { font-family: 'Roboto Mono', monospace !important; text-transform: uppercase; }
    ...
    /* Mata o erro 'KEYBOARD' e limpa o topo */
    ...
    /* Estilo da Sidebar (Variáveis à Esquerda) */
    ...
    /* Trava 16h em LARANJA */
    .trava-laranja { color: #FF8C00 !important; font-size: 16px; margin-top: 15px; font-weight: bold; }
    </style>
...
while True:
    with placeholder.container():
        ...
        if not spot_df.empty:
            ...
            # Lógica da Trava (Correção do Erro de Atributo)
            try:
            ...
            # TRAVA 16H EM LARANJA
            st.markdown(f'<div class="trava-lar
