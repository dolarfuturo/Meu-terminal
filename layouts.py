Olhas as setas que indicam vermelha e verde.   No bloco da  seta vermelha:  voce só mantenha o AXIS, e limpa o resto .. agora,voce pega a (Max - Min /8 do spot) = SPREED.  Max Fut= AXIS + Max do spot +SPREED | MIN FUT= AXIS - Min spot + SPREDD ..... No bloco da seta verde:  apenas troca a MEDIA DOL; pega a (Max + min do spot e divide por 2)...   Aqui o código para ajusta   import streamlit as st
