    ...
    with placeholder.container():
        ...
        if res:
            ...
            with c1:
                ...
                media_term = (v_dxy) - (v_ewz) * 0.1
                
                c_bf, c_b, c_n, c_a, c_af = "", "", "", "", ""
                if media_term <= -0.4: c_bf = "active-bf"
                elif media_term < -0.2: c_b = "active-b"
                elif media_term <= 0.2: c_n = "active-n"
                elif media_term < 0.4: c_a = "active-a"
                else: c_af = "active-af"
            ...
            with c2:
                ...
                media_term_c2 = (get_var_local("DX-Y.NYB") - get_var_local("EWZ")) * 0.1 
