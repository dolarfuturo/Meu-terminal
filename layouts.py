...
# --- CSS: LIMPEZA TOTAL E ESTILIZAÇÃO ---
st.markdown("""
<style>
    /* 1. ESCONDE A BARRA DE ATUALIZAÇÃO (RUNNING) */
    div[data-testid="stStatusWidget"] { display: none !important; }
    
    /* 2. ESCONDE ICONES DE FORK, ESTRELA E BONEQUINHO */
    .stAppToolbar { visibility: hidden !important; }
    footer { visibility: hidden !important; }
    
    /* 3. MANTÉM APENAS O BOTÃO DO MENU (SIDEBAR) */
    [data-testid="stHeader"] {
        background: transparent !important;
        color: white !important;
    }
    /* Garante que o botão da sidebar fique visível mesmo com toolbar oculta */
...
if res:
    ...
    with c_main:
        ...
        outros = {"SPOT": "USDBRL=X", "DXY": "DX-Y.NYB", "EWZ": "EWZ", "GBP/USD": "GBPUSD=X", "JPY/USD": "JPYUSD=X", "EUR/USD": "EURUSD=X", "XAU/USD": "GC=F", "BRENT": "BZ=F"}
