...
# --- CSS: DESIGN TERMINAL REESTRUTURADO ---
st.markdown("""
<style>
    ...
    .calc-row { display: flex; justify-content: space-between; padding: 3px 6px; border-bottom: 1px solid #444; font-size: 10px; font-weight: bold; align-items: center; }
    
    /* Barra de Força Larga para ficar sob a Grade */
    .bar-wrapper-full { background: #0a141a; padding: 10px; border: 1.5px solid #ffffff; border-radius: 4px; text-align: center; margin-top: 5px; }
    .force-scale { display: flex; justify-content: space-between; font-size: 9px; font-family: monospace; color: #AAA; margin-bottom: 4px; padding: 0 5px; }
    .force-container-dual { background: #111; height: 14px; width: 100%; border-radius: 2px; position: relative; overflow: hidden; display: flex; border: 1px solid #444; }
    ...
    .sinal-indicator { font-size: 14px; font-weight: 900; line-height: 1; margin-top: 6px; min-height: 16px; }
        ...
        if spot_live and ewz_live:
            ...
            if res:
                ...
                with c_main:
                    ...
                    # --- BARRA DE FORÇA ABAIXO DA GRADE PRINCIPAL ---
                ...
                # --- TICKER (RODAPÉ) COLADO LOGO ABAIXO ---
