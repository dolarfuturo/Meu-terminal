        ...
        if res:
            ...
            with c1:
                ...
                render_barra = (
                    ...
                    '        <span style="color:#00ff88; width:15%; text-align:left;">-0.50%</span>'
                    '        <span style="color:#00ff88; width:15%; text-align:left;">-0.25%</span>'
                    '        <span style="color:#ffffff; width:10%; text-align:center;">0</span>'
                    '        <span style="color:#ff4d4d; width:15%; text-align:right;">+0.25%</span>'
                    '        <span style="color:#ff4d4d; width:15%; text-align:right;">+0.50%</span>'
