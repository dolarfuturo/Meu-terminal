...
def calcular_k97_total(eixo_ewz, p_ewz_atual, max_ewz, min_ewz, eixo_dol, spot_data):
    try:
        ...
        return {
            "vivo": dolar_vivo, "fraja": dolar_fraja, "medio": media_dol_nova, "ewz_med": ewz_medio_dia,
...
if res:
    ...
    with c_side:
        # BLOCO SUPERIOR (MANTIDO INTEGRALMENTE COM NOVAS FORMULAS MÁX/MIN)
        ...
        # BLOCO INFERIOR (MANTIDO INTEGRALMENTE COM MÉDIA DOL ATUALIZADA)
