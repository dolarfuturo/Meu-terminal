...
if 't_br_val' not in st.session_state: st.session_state.t_br_val = 13.75
...
def calcular_k97_total(spreed_do_dia, spot_data, ewz_data):
    try:
        ...
        frac_3 = round(1.0 + (t_delta * 0.70), 5)
        frac_4 = taxa_juros
    ...
    with placeholder.container():
        ...
        if res:
            ...
            with c2:
                ...
                media_term_c2 = -get_var_local("EWZ") * 0.45
