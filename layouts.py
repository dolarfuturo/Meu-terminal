...
# --- CSS: APENAS REMOÇÃO DE ELEMENTOS INDESEJADOS E POSICIONAMENTO DO BOTÃO ---
st.markdown("""
<style>
    /* 1. ESCONDE A BARRA PRETA E ICONES (BONECOS/FORK) */
    header[data-testid="stHeader"] { visibility: hidden !important; }
    footer { visibility: hidden !important; }
    div[data-testid="stStatusWidget"] { display: none !important; }

    /* 2. REPOSICIONA O BOTÃO DE ACESSO AO PAINEL ADM */
    /* Ele fica invisível por causa do header, então forçamos ele de volta */
