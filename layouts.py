...
# --- CSS: ESTILIZAÇÃO COMPACTA (100% IGUAL AO SEU) ---
st.markdown("""
<style>
...
# --- INICIALIZAÇÃO E PAINEL ADM (FIXO) ---
...
with st.sidebar:
    ...
    with st.expander("AJUSTAR AXIS", expanded=True):
...
# --- ESPAÇO DO CONTEÚDO (O QUE NÃO PISCA) ---
    ...
    if res:
        with placeholder.container():
            ...
            with c_main:
                ...
                v_v = res['v_v']
                dolfut_calc = st.session_state.a_dol * (1 + (v_v / 100))
