...
# --- CÁLCULO AUTOMÁTICO DO EIXO EWZ (SENTINELA 18H) ---
...
ewz_live = fetch("EWZ")
if ewz_live:
    # Chama o motor usando a mx_ref e mn_ref AUTOMÁTICAS do eixo
    ...
    # Sintético 2.0 com as Max/Min projetadas conforme o código original
