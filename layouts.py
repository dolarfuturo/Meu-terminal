...
# --- CSS: AJUSTE DE PERFORMANCE E VISUAL ---
st.markdown("""
<style>
...
# --- MOTOR DE CARREGAMENTO RÁPIDO ---
def fetch(s):
    try:
        t = yf.Ticker(s)
        # Download otimizado: apenas o necessário para o preço atual e variação básica
...
while True:
    ...
    # Carregamento de ativos (Ordem de prioridade)
    ...
    # Delay otimizado para não travar a CPU do tablet
    time.sleep(2.5)
