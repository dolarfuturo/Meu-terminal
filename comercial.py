...
# 4. BARRA LATERAL (ENGRENAGEM / SETA) - SÓ APARECE PARA ADM
if st.session_state.user_type == "ADM":
    with st.sidebar:
        st.header("⚙️ AJUSTE GLOBAL")
        # Ao mudar aqui, altera o v_global que é compartilhado com todos
        ...
        st.info("Valores aplicados a todos os terminais.")
else:
    # ESCONDE A BARRA LATERAL PARA CLIENTES
    st.markdown("<style>[data-testid='stSidebar'] { display: none !important; }</style>", unsafe_allow_html=True)

# 5. CSS - LIMPEZA DO TOPO E ESTILO INDUSTRIAL
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@400;700&family=Orbitron:wght@400;900&display=swap');
    
    /* REMOVE FORK E ÍCONES DO GITHUB */
    .stAppDeployButton, [data-testid="stToolbar"], footer { display: none !important; }
    
    /* MOSTRA A SETA NO TOPO APENAS PARA O ADM */
    header { 
...
while True:
    ...
    if m:
        ...
        with terminal_placeholder.container():
            ...
            # PARIDADE E EQUILÍBRIO SINCRONIZADOS
            ...
            st.markdown(f"""
                <div class="d-row">
                    ...
                    <div class="sub-grid">
                        ...
                        <div class="sub-item"><span class="sub-l">MAX</span><span class="
