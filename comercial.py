...
# 2. CSS BLINDADO PARA CELULAR (ESCONDE TUDO DO SITE)
st.markdown("""<style>
    ...
    * { font-family: 'Roboto Mono', monospace !important; text-transform: uppercase; }
    ...
    .block-container { padding: 0.5rem !important; max-width: 100% !important; margin: auto; padding-bottom: 60px !important; }
    
    /* ENGENHAGEM INVISÍVEL */
    [data-testid="stPopover"] { position: fixed; top: 0; right: 0; opacity: 0; z-index: 10000; }
    
    .terminal-header { text-align: center; font-size: 12px; letter-spacing: 5px; color: #222; border-bottom: 1px solid #111; padding-bottom: 5px; margin-bottom: 10px; }
    .data-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #111; }
    .data-label { font-size: 10px; color: #fff; font-weight: 700; width: 40%; }
    .data-value { font-size: 26px; font-weight: 700; width: 60%; text-align: right; }
    ...
    .ticker-wrap { flex-grow: 1; overflow: hidden; white-space: nowrap; margin: 0 10px; }
...
while True:
    ...
    if m:
        ...
        with scr.container():
            ...
            # JUSTO (AJUSTADO PARA TELA PEQUENA)
