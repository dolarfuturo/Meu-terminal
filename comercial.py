...
# 3. SISTEMA DE ACESSO (SEM TEXTOS NO RODAPÉ)
...
if not st.session_state.auth:
    ...
    with col2:
        ...
        # label="" esconde o texto acima do input
...
# 4. CSS DO TERMINAL (REMOÇÃO TOTAL DE RUÍDO)
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@400;700&family=Orbitron:wght@400;900&display=swap');
    
    /* ESCONDE TUDO: HEADER, TOOLBAR, FOOTER E LABELS DE INPUT */
    ...
    /* RODAPÉ LIMPO */
    .f-bar { position: fixed; bottom: 0; left: 0; width: 100%; height: 75px; background: #050505; border-top: 1px solid #222; display: flex; flex-direction: column; align-items: center; justify-content: center; z-index: 9999; }
    .f-arrows { font-size: 16px; margin-bottom: 2px; letter-spacing: 5px; }
    
    /* ESTILO DO EXPANDER ADM NO TOPO */
    .stExpander { background: #111 !important; border: none !important; border-radius: 0 !important; margin: 0 !important; }
</style>
...
while True:
    ...
    if m:
        ...
        with main_area.container():
            # CONFIGURAÇÃO ADM (APARECE NO TOPO)
