...
# 3. ACESSO MINIMALISTA (SEM TEXTOS)
...
# 4. CSS (DIVISÓRIA NO RODAPÉ E LIMPEZA)
st.markdown("""
<style>
    ...
    /* LINHA SEM NEGRITO */
    .f-line { width: 80%; height: 1px; background: rgba(255,255,255,0.1); margin-bottom: 8px; }
    
    .tk-wrap { width: 100%; overflow: hidden; white-space: nowrap; }
    .tk-move { display: inline-block; white-space: nowrap; animation: slide 30s linear infinite; }
    .tk-item { padding-right: 60px; display: inline-block; font-family: 'Chakra Petch'; font-size: 13px; color: #fff; }

    @keyframes slide { 0% { transform: translateX(100%); } 100% { transform: translateX(-100%); } }

    /* EXPANDER ADM OCULTO (SÓ ABRE PELA SETA LATERAL SE PRECISAR OU DEIXAMOS NO TOPO DISCRETO) */
...
while True:
    ...
    if m:
        ...
        with ui_area.container():
            # Painel ADM agora é um expander vazio no topo, quase invisível
